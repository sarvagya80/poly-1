...
const ABI = require("../artifacts/contracts/pahad.sol/pahad.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("pahad");
  const nft = await NFT.attach("0x588Ebb180206c03D8Dd756Cb23bA1ea4044B000D");
